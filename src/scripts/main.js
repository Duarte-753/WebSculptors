...
ScrollReveal().reveal('.home-content, heading, .about-content .heading, .services h2, .planos heading, .portifolio h2, .contact h2', { origin: 'top'});
ScrollReveal().reveal('.home-img, .contact form, .about-content p, .portifolio-box, .services-container, .planos-container', { origin: 'bottom' }); /*.services-box, fica bugando meu css*/
ScrollReveal().reveal('.home-contact h1, .about-img, .about-content h3', { origin: 'left' });
